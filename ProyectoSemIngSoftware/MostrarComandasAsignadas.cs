...
{
    public partial class MostrarComandasAsignadas : Form
    {
        String id_mesero;
        public MostrarComandasAsignadas(String id)
        {
            InitializeComponent();
            id_mesero = id;
        }
        ...
        private void MostrarComandasAsignadas_Load(object sender, EventArgs e)
        {
            ...
            buscar.CommandText = ("select IDComanda, ID_Cocinero from comanda where ID_Mesero = '" + id_mesero + "' and Estatus = 'Asignada'");
