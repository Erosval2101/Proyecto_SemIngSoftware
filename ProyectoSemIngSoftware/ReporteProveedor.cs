...
namespace ProyectoSemIngSoftware
{
    public partial class ReporteProveedor : Form
    {
        ...
        private void ReporteProveedor_Load(object sender, EventArgs e)
        {
            ...
            conectar.Open();
            MySqlCommand buscar = new MySqlCommand("select * from proveedor", conectar);
            ...
            try
            {
                ...
                dtgvProveedor.DataSource = bSource;
                sda.Update(dbdataset);
                int cont = dtgvProveedor.RowCount;
                for (int i = 0; i < cont; i++)
                {
                    dtgvProveedor.Rows[i].Height = 150;
                }
