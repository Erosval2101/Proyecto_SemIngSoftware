...
namespace ProyectoSemIngSoftware
{
    public partial class ReporteEmpleado : Form
    {
        ...
        private void ReporteEmpleado_Load(object sender, EventArgs e)
        {
            ...
            conectar.Open();
            MySqlCommand buscar = new MySqlCommand("select * from empleado", conectar);
            ...
            try
            {
                ...
                int cont = dtgvEmpleado.RowCount;
            }
            catch (Exception ex)
            {
                MessageBox.Show("No se encontraron empleados", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
